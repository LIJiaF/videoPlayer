				...
				<table width="90%"  align="center" cellpadding="5" cellspacing="1" class="tablecss" >
					...
					<tr>
					  ...
					  <td width="680" valign="middle">
					  	...
					  	<span class="gray tips">网站名称，如：86电影网</span>
					  </td>
					</tr>
					<tr>
					    ...
					    <td width="680" valign="middle">
					      ...
					      <span class="gray tips">网站域名，如：https://www.i0886.com/ </span>
					    </td>
					</tr>
					<tr>
					...
					<tr>
					    ...
					    <td valign="top"><span class="gray tips">https://www.i0886.com/</span><br>
					...
					<tr>
					    <td width="125" align="right" valign="middle" class="s_title" style="font-weight: bold">QQ群</td>
					    <td valign="top"><span class="gray tips">https://www.i0886.com/</span><br>
					...
					<tr>
					    <td width="125" align="right" valign="middle" class="s_title" style="font-weight: bold">微博</td>
					    <td valign="top">
					    	<input type="text" name="aik[weibourl]" placeholder="https://www.i0886.com/" class="shuru" value="<?php echo $aik['weibourl']?>" size="100"><br/>	
					    </td>
					</tr>
